...
export default function SearchOverlay({ isOpen, onClose }: SearchOverlayProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 z-50 h-full w-full max-w-[420px] border-l border-white/10 bg-[#111111] transition-transform duration-300 ease-in-out ${
            ...
            filtered.map((animation, index) => (
              ...
              >
                <div className="flex flex-col gap-2">
                  <span className="text-[1.1rem] font-normal text-white">{animation.title}</span>
